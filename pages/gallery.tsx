...
import GallerySV from "./../visions/GallerySV";
...
const sv = (p: p5, h: Hydra): void => {
  ...
  svManager.addItem(SyntheticsVisions.Gallery, new GallerySV());
  ...
  p.setup = (): void => {
    svManager.getItem(SyntheticsVisions.Gallery)!.initialize(p, h);
  };
