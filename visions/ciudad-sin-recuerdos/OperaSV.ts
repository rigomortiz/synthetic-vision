...
class OperaSV extends SyntheticVisionAbstract {
	...
	buttons: p5.Element[] = [];
	urls: string[] = [
	  "https://syntheticvision.netlify.app/ciudad-sin-recuerdos/opera/scenes/1",
	  "https://syntheticvision.netlify.app/ciudad-sin-recuerdos/opera/scenes/2",
	  "https://syntheticvision.netlify.app/ciudad-sin-recuerdos/opera/scenes/3",
	  "https://syntheticvision.netlify.app/ciudad-sin-recuerdos/opera/scenes/4"
	];
